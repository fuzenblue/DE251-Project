...
const WorkshopInfo = () => {
  ...
  const bookWorkshop = async () => {
    ...
    try {
      ...
      console.log('Booking request:', { workshopId, slotDate, slotTime })
        ...
        <div className="flex mt-4 flex-col md:flex-row gap-5">
          ...
          <div className="flex-1 rounded-lg">
            <div className="max-h-48 md:h-auto overflow-y-scroll xl:overflow-clip">
              <p className="flex items-center gap-1 text-lg font-medium text-gray-600 mt-3">Description about this workshop <img src={assets.info_icon} alt="" /></p>
          ...
          <div className="w-full md:w-1/2 md:ml-4 font-medium text-gray-700">
            ...
            <div className="flex gap-4 items-center w-full overflow-x-auto m-5">
              {
                workshopSlots.length && workshopSlots[slotIndex].map((item, index) => (
