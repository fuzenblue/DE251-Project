...
const AboutUs = () => {
  return (
    <div className="w-full">
      {/* Hero Section */}
        <header className="relative min-h-[60vh] flex flex-col justify-center items-center text-center px-8 py-16 bg-gradient-to-r from-orange-200 to-orange-100">
            <img 
                src={fame.about_head} 
                alt="Pineapple farm hero" 
                className="absolute inset-0 w-full h-full object-cover"
            />
            <div className="absolute inset-0 bg-black opacity-50 z-0"></div> {/* เพิ่มพื้นหลังสีดำโปร่งใส */}
        ...
        <section className="relative px-4 py-20 bg-cover bg-center" style={{
          ...
          <div className="relative z-10 max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="group relative overflow-hidden rounded-2xl bg-amber-600 p-8 shadow-xl ring-1 ring-gray-100 hover:shadow-2xl transition-all duration-300">
                <div className="absolute -right-12 -top-12 h-32 w-32 bg-black/10 rounded-full transition-transform group-hover:scale-150" />
                <div className="absolute -right-2 -top-2 h-16 w-16 bg-black/20 rounded-full transition-transform group-hover:scale-150" />
                <div className="relative">
                  <div className="flex items-center justify-center w-16 h-16 bg-amber-500 rounded-xl shadow-lg mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 12l2 2 4-4m0 0L10 6M14 12l4-4m0 0l-2-2M12 16l-4-4m0 0l-2 2" />
                    </svg>
                  </div>
                  <h3 className="text-2xl font-bold text-gray-800 mb-2">Community Focus</h3>
                  <p className="text-gray-700">We are deeply committed to supporting our local community through sustainable farming practices and educational initiatives.</p>
                </div>
              </div>
            </div>
          </div>
