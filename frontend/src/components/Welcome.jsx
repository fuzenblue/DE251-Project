  ...
  return (
    <>
        <div className="flex flex-col items-center px-6 lg:flex-row lg:px-[10%] md:px-8 sm:px-4">
            <div className="w-full lg:w-3/5 text-white mb-6 lg:mb-0">
            ...
            <div className="w-full lg:w-4/5 text-dark-brown mt-6 lg:mt-0">
        ...
        {/* card */}
        <div className="flex flex-row overflow-x-auto gap-4 px-6 my-6 lg:px-[10%] lg:gap-14">
